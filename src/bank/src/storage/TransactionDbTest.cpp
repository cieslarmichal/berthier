...
namespace
{
const auto transaction1 = Transaction{"water", "shop", "food", 3, "date1"};
const auto transaction2 = Transaction{"orange", "fruit shop", "food", 1, "date2"};
const auto transaction1Serialized =
    R"({"name":"water","recipient":"shop","category":"food","amount":3,"date":"date1"})";
const auto transaction2Serialized =
    R"({"name":"orange","recipient":"fruit shop","category":"food","amount":1,"date":"date2"})";
